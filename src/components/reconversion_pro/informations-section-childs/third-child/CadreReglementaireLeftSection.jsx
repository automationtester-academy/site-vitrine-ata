    ...
    return (
        <div className="w-full">
            <div className="flex mb-6 container-title">
                <img src={WritingImg} width="54" height="56" alt="Writing Img" className="mr-3 h-14 self-center" />
