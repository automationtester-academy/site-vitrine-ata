    ...
    return (
        <div className="p-3 h-100 overflow-auto">
            ...
            <div className="mt-4">
                ...
                <div className="pl-8 mt-4">
                    <ul>
                        <li className="list-disc text-2xl font-semibold text-[#3390B2] cadre-reglementaire-p"> <span  style={{color:'#3adef5'}}>60%</span> <span className="text-xl font-medium text-white">3 mois post formation</span></li>
                    </ul>
                </div>
            </div>
            <div className="mt-5">
