...
export default function DescriptionFC() {
  return (
    <div className="description-container text-center p-10">
      <h2 className="text-5xl font-bold text-[#39DDF5] mb-4">Nos formations courtes</h2>
      <p className="text-white mt-4 leading-[29.26px] text-center font-[Montserrat] text-[24px] font-medium p-[20px]">
