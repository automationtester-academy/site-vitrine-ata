...
export default function DevenirTesteur(){
    return(
        ...
        <section className="flex justify-center items-center flex-col gap-2 ">
            ...
            <div className="w-[30%] flex justify-center mb-[4%] mt-[1.5%] max-xl:w-[40%] max-lg:w-[60%] max-sm:w-[100%] max-sm:mx-[1%] max-sm:flex-col max-sm:justify-center max-sm:items-center m-auto">
