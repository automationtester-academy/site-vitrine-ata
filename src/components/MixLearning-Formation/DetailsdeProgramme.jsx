...
export default function DetailsdeProgramme(){
    return(
        <>
            <section className="w-[45%] flex flex-col gap-6 max-xl:w-[100%] max-lg:w-[100%] max-sm:w-[100%]">
                <div className="border-2 border-cyan-400 pt-[9%] pb-[4%] flex  justify-center items-center flex-col rounded-xl">
