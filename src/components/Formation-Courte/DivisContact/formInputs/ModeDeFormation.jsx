        ...
        <div className="flex-1 px-2">
            <div className="relative h-11 w-full min-w-[200px]">
                ...
                <select id="underline_select" name="modeDeFormation"
                    ...
                    value={value}
                    onChange={onChange}>
                    <option className='bg-[#071323]' value="Distanciel">Distanciel</option>
                    <option className='bg-[#071323]' value="Locaux d'entreprise">Locaux d'entreprise</option>
                    <option className='bg-[#071323]' value="Notre site">Notre site</option>
                </select>
                <label
