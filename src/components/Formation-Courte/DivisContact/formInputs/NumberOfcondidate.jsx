        ...
        <div className="flex-1 px-2">
            ...
            <div className="relative h-11 w-full min-w-[200px]    max-sm:mb-10">
                ...
                <select id="underline_select" name="numberOfCondidates"
                    ...
                    value={value}
                    onChange={onChange}>
                    <option className='bg-[#071323]' value="0-5" selected>0-5</option>
                    <option className='bg-[#071323]' value="10-20" selected>10-20</option>
                    <option className='bg-[#071323]' value="30+" selected>30+</option>
                </select>
                <label
