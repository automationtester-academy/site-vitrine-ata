        ...
        <div className="flex-1 px-2 max-sm:mb-12">
            <div className="relative h-11 w-full min-w-[200px]">
                ...
                <select id="underline_select" name="formation"
                    ...
                    <option className='bg-[#071323]' value="Git">Git</option>
                    <option className='bg-[#071323]' value="Robot Framework">Robot Framework</option>
                    <option className='bg-[#071323]' value="Test Mobile">Test Mobile</option>
                    <option className='bg-[#071323]' value="Playwright">Playwright</option>
                </select>
                <label
