...
export default function DemandeDeEmploiSixthDropDown() {
        ...
        <>
            <div className="container mx-auto flex flex-col items-center justify-center">
                ...
                >
                    ...
                    <span className={`ml-4 text-xl ${textColor}`}>La Préparation opérationnelle à l'emploi individuelle</span>
                </button>
                {isActive && (
                    <div className="mt-4 w-11/12 p-4 drop-down-style">
                        <div>
                            ...
                            <div className="my-2">
                                <p className="text-xl text-white">La POEI c’est la Préparation Opérationnelle à l’Emploi Individuelle
                                </p>
                            </div>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <div className="my-2">
                                <p className="text-xl text-white">3 : Monter votre dossier de demande de financement Pole Emploi, Ce dossier consiste à exposer ton projet professionnel, ta motivation ainsi que ton choix de formation. Notre équipe vous enverras aussi des conseils pour préparer votre argumentaire pour votre demande. Ces conseils porteront sur la présentation et la cohérence de votre projet professionnel, la pertinence du parcours de formation et des modalités de financement ainsi que sur les perspectives d’emploi à l’issue de la formation.</p>
                            </div>
                            <div className="my-2">
