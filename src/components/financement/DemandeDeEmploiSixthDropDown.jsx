            ...
            <div>
              ...
              <div className="my-2">
                <p className="text-xl text-white">
                  ...
                  professionnel, ta motivation ainsi que ton choix de
                  formation. Notre équipe vous enverras aussi des conseils pour
                  préparer votre argumentaire pour votre demande. Ces conseils
                  porteront sur la présentation et la cohérence de votre projet
