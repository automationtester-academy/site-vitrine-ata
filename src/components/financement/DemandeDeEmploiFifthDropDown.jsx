                ...
                {isActive && (
                    <div className="mt-4 w-11/12 p-4 drop-down-style">
                        <div>
                            ...
                            <div className="my-2">
                                <p className="text-xl text-white">L’autofinancement est le fait de payer sa formation, en totalité ou en partie avec un paiement en plusieurs mensualités.</p>
                            </div>
                        </div>
                        <div>
                            <div className="my-2">
                        ...
                        <div>
                            ...
                            <div className="my-2">
                                <p className="text-xl text-white">3 : signer le devis de formation</p>
                            </div>
                            <div className="my-2">
                                <p className="text-xl text-white">4 : fournir les éléments à la validation du dossier d’inscription</p>
                            </div>
                            <div className="my-2">
                                <p className="text-xl text-white">5 : signer le contrat de formation</p>
                            </div>
                        </div>
                    </div>
                )}
