...
export default function SalarieFourthDropDown() {
        ...
        <>
            <div className="container mx-auto flex flex-col items-center justify-center">
                ...
                >
                    ...
                    <span className={`ml-4 text-xl ${textColor}`}>Le CPF et cofinancement par l'entreprise</span>
                </button>
                {isActive && (
                    <div className="mt-4 w-11/12 p-4 drop-down-style">
                        ...
                        <div>
                            ...
                            <div className="my-2">
                                <p className="text-xl text-white">Inscrivez-vous et passez notre parcours d’admissibilité : le Chemin vers  Automation Tester Academy.<br />
                                    Laissez-vous guider par votre référent admission deAutomation Tester Academy.</p>
                            </div>
                            <div className="my-2">
