        ...
        {isActive && (
          <div className="mt-4 w-11/12 p-4 drop-down-style">
            ...
            <div>
              ...
              <div className="my-2">
                <p className="text-xl text-white">
                  <strong>Public :</strong> Demandeurs d’emploi et avoir une
                  entreprise prête à vous embaucher
                </p>
              </div>
            </div>
            <div>
              ...
              <div className="my-2">
                <p className="text-xl text-white">
                  La POEI, c’est la Préparation Opérationnelle à l’Emploi
                  Individuelle. Ce dispositif de
                </p>
              </div>
              <div className="my-2">
                <p className="text-xl text-white">
                  financement est très différent des autres puisqu’il permet de
                  suivre votre formation en
                </p>
              </div>
              <div className="my-2">
                <p className="text-xl text-white">
                  lien direct avec une offre d’emploi d’une entreprise. Si le
                  futur employeur se positionne
                </p>
              </div>
              <div className="my-2">
                <p className="text-xl text-white">
                  sur votre profil, vous pouvez commencer votre intégration en
                  douceur dans leurs
                </p>
              </div>
              <div className="my-2">
                <p className="text-xl text-white">
                  équipes, le tout avec une formation financée par Pôle Emploi
                  en partie ou
                </p>
              </div>
              <div className="my-2">
