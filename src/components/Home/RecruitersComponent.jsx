    ...
    return(
        ...
        <section className="Recruiters h-[22.25rem] w-full bg-slate-900 border-b-2 max-sm:h-max ">
            <div className="Recruiters_Text flex justify-center mb-10">
                <p className="text-white text-4xl font-bold mt-16 max-sm:text-3xl max-sm:!text-center max-sm:px-3">Ils ont recruté <span className="text-cyan-400">nos alumni</span></p>
            </div>
