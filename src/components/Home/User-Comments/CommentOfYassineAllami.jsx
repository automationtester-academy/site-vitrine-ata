import BoyProfilPicture from '../../../assets/images/Profils/Boy2.svg'
export default function CommentOfYassineAllami(){
    return(
        <>
        <div className="Comment_content block w-[36%] px-6 pt-6 pb-2 bg-white border border-gray-200 rounded-3xl shadow  dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 max-sm:w-[100%]">        
            ...
            <div className="Comments_profil_image flex flex-row mt-[4%]">
                ...
                <p className="text-black text-xl font-bold  flex self-center px-6">Yassine <span className="text-cyan-400 ms-1"> Allami</span></p>
            </div> 
        </div>
