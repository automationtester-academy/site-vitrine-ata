            ...
            <div className="HeroSection_Learningbydoing_main flex justify-between  h-[65vh] ml-56 mt-10 mb-20 2xl:max-3xl:bg-red-300   lg:max-xl:mb-[0%] lg:max-xl:w-[100%] lg:max-xl:mx-[0%] lg:max-xl:h-[90%]  sm:max-lg:w-full sm:max-lg:mx-0  max-sm:mx-0 max-sm:flex-col  max-sm:h-fit">
                ...
                <div className="HeroSection_Learningbydoing_image_container relative mr-16  max-sm:w-full  max-sm:h-full max-sm:static ">
                    ...
                    <div className="HeroSection_Learningbydoing_text flex flex-col lg:max-xl:items-center  text-overlay absolute left-0 top-0 sm:max-lg:mt-[5%] sm:max-lg:w-[115%] max-sm:top-[115vh] max-sm:w-full max-sm:static max-sm:h-fit">
                        ...
                        <p className=" Herosection_Text_Title_paragraph_learning text-center text-white w-10/12 text-lg leading-[119%] mb-[3.5%] ml-5 sm:max-lg:w-[90%] lg:max-xl:w-[100%]  sm:max-lg:text-base max-sm:w-[90%]">Nous croyons fermement que la pratique est essentielle pour maîtriser l'automatisation. C'est pourquoi notre approche pédagogique repose sur des exercices pratiques et des projets concrets. En participant à des simulations réelles et en travaillant sur des cas d'étude, vous aurez l'occasion de mettre en application les concepts théoriques appris en cours.</p>
                        <p className="Herosection_Text_Title_paragraph_learning text-center w-10/12 text-white ml-3 text-lg leading-[119%] lg:max-xl:w-[100%] sm:max-lg:w-[90%] sm:max-lg:text-base  max-sm:w-[90%]">Cette méthode d'apprentissage active garantit que vous acquérez non seulement des connaissances, mais aussi la confiance nécessaire pour les appliquer dans un environnement professionnel.</p>
