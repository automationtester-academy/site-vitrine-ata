export default function FinancerSaFormationTextChild() {
    return (
        <>
        <div className='financer-text-background flex flex-col justify-between'>
            ...
            <div>
                <p className="text-center">Entre AIF, CPF, CSP, Transitions Pro, Agefiph, on peut vite s’y perdre.</p>
            </div>
            <div>
                <p className="text-center">Alors, on a décidé de vous accompagner dans les méandres des solutions de financement : la Team Admissions & Financements 
                    est là pour ça !</p>
            </div>
        </div>
        </>
